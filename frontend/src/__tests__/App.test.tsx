...
describe('App', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    (fetchRecommendations as ReturnType<typeof vi.fn>).mockResolvedValue(mockRecommendations);
    (fetchNews as ReturnType<typeof vi.fn>).mockResolvedValue(mockNews);
    (fetchSectorTrends as ReturnType<typeof vi.fn>).mockResolvedValue(mockSectorTrends);
