...
function RecommendationCard({ item, onSelect, }) {
    ...
    return (_jsxs("li", { onClick: () => onSelect?.(item.krx_code), style: {
            ...
            transition: 'box-shadow 0.15s',
                        ...
                        }, children: ["\uC885\uD569 ", (item.total_score * 100).toFixed(1), "\uC810"] })] }), _jsxs("div", { style: { marginBottom: '0.75rem' }, children: [_jsx(ScoreBar, { score: item.sentiment_score, label: "\uAC10\uC131" }), _jsx(ScoreBar, { score: item.volume_score, label: "\uAC70\uB798\uB7C9" }), _jsx(ScoreBar, { score: item.momentum_score, label: "\uBAA8\uBA58\uD140" }), _jsx(ScoreBar, { score: item.anomaly_score, label: "\uC774\uC0C1\uAC10\uC9C0" })] }), _jsx("p", { style: {
                    margin: 0,
                    fontSize: '0.875rem',
                    color: '#444',
                    lineHeight: 1.6,
...
export function RecommendationList({ recommendations, onSelect }) {
    return (_jsxs("section", { "aria-labelledby": "recommendation-heading", children: [_jsx("h2", { id: "recommendation-heading", style: { fontSize: '1.25rem', fontWeight: 700, marginBottom: '1rem', color: '#212121' }, children: "\uC624\uB298\uC758 \uC8FC\uC2DD \uCD94\uCC9C" }), _jsx("ul", { style: { display: 'flex', flexDirection: 'column', gap: '0.75rem', padding: 0, margin: 0 }, "aria-label": "\uC8FC\uC2DD \uCD94\uCC9C \uBAA9\uB85D", children: recommendations.map((item) => (_jsx(RecommendationCard, { item: item, onSelect: onSelect }, item.krx_code))) })] }));
}
