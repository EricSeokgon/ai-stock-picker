...
// 공개 포트폴리오 피드 페이지 (SPEC-STOCK-042, SPEC-STOCK-045, 인증 불필요)
...
export default function Feed() {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', flexWrap: 'wrap', gap: '0.5rem' }, children: [_jsx("h2", { style: { margin: 0, color: '#0d47a1' }, children: "포트폴리오 피드" }), _jsxs("div", { style: { display: 'flex', gap: '0.5rem' }, children: [_jsx("button", { style: sortBtnStyle(sort === 'likes'), onClick: () => { setSort('likes'); setPage(1); }, children: "좋아요순" }), _jsx("button", { style: sortBtnStyle(sort === 'recent'), onClick: () => { setSort('recent'); setPage(1); }, children: "최신순" }), _jsx("button", { style: sortBtnStyle(sort === 'trending'), onClick: () => { setSort('trending'); setPage(1); }, children: "트렌딩" })] })] }), _jsxs("form", { onSubmit: handleSearch, style: { display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }, children: [_jsx("input", { type: "text", value: query, onChange: (e) => setQuery(e.target.value), placeholder: "포트폴리오 이름 검색...", "aria-label": "포트폴리오 이름 검색", style: {
                            flex: 1,
                            ...
                            cursor: 'pointer',
                            fontSize: '0.875rem',
                        }, children: "검색" })] }), error && (_jsx("div", { role: "alert", style: {
